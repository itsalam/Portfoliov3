...
const TextInput = forwardRef(
  (props: HTMLProps<HTMLTextAreaElement> & InputProps, _) => (
    <Input
      {...props}
...
const TextArea = forwardRef(
  (props: HTMLProps<HTMLTextAreaElement> & TextareaProps, _) => (
    <Textarea
      {...props}
...
const FormInput = (
  props: HTMLProps<HTMLDivElement> & FormControlProps & FormInputProps
) => (
  <FormControl
    id={props.id}
