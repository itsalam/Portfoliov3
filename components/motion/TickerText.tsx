...
export const TickerText = ({ children, className, ...props }: TickerTextProps) => {
    ...
    useEffect(() => {
        animate(scope.current, {
            ...
            {
                duration: 12, // Adjust to control speed
                ease: "linear",
                repeat: Infinity,
            },
        )
    ...
    const handleMouseMove = (event: React.MouseEvent) => {
        ...
        x.set(-mouseX * 0.1); // Set ticker position to follow the mouse
        console.log(x.get())
    };
    ...
    >
        <m.div style={{ x }}>
            <m.div className="flex relative w-min" ref={scope}
            >
